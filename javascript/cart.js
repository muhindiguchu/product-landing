...
let newCart = [
    { product: 'Yeezy 450 "cloud Black"', price: 1500 },
    { product: 'Yeezy 450 "cloud Grey"', price: 1500 },
    { product: "Converse chuck Taylor", price: 2000 },
    { product: "Adidas Samba", price: 1500 },
    { product: "Puma Vikky Platform", price: 1500 },
    { product: "Converse Chuck Taylor All Star 70", price: 2300 },
    { product: "Yeezy 450 'cloud Grey'", price: 1500 },
    { product: "Air Jordan 1 High Dior", price: 2000 },
];
...
document.getElementById("add").onclick = function () { 
    document.getElementById("product").innerHTML = newCart[0].product;
    document.getElementById("price").innerHTML = newCart[0].price + " Ksh";
};

// let button = document.getElementById("tired");
// button.onclick = function () {
// let product3 = "Yeezy 450 'cloud Grey'";

// let price3 = 1500;
// let myCart2 = [product3, price3];
// localStorage.setItem("myCart2", JSON.stringify(myCart2));
// let cart1 = JSON.parse(localStorage.getItem("myCart2"));
// // cart.push({product: product3, price: price3});
// document.getElementById("product3").innerHTML = cart1[0];
// document.getElementById("price3").innerHTML = cart1[1];
// };